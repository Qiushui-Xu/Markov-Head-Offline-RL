...
def get_args():
    ...
    parser.add_argument('--embed_dim', type=int, default=768, help="dt token embedding dimension")
    ...
    parser.add_argument('--arch_lr', type=float, default=6e-3, help="arch learning rate of Trainer" )
    ...
    parser.add_argument('--ctl_lr', type=float, default=6e-3, help="gate learning rate of Trainer" )
    parser.add_argument("--use_control", action='store_false', default=False)
...
def train(args = get_args()):
    ...
    tconf = TrainerConfig(
                max_epochs=args.epoch, batch_size=args.batch_size, arch_lr=args.arch_lr, 
                use_control=args.use_control, ctl_lr=args.ctl_lr, frec=args.frec, 
